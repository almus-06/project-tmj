...
@section('content')
    ...
    <div class="flex flex-wrap items-center justify-between gap-4 mb-8">
        ...
        <div class="flex items-center gap-3">
            <a href="{{ route('fleet.management', ['export' => 'csv'] + request()->all()) }}"
               class="inline-flex items-center gap-2 bg-slate-900 text-white text-xs font-bold px-5 py-2.5 rounded-lg hover:bg-slate-800 transition-all shadow-sm">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
        ...
        <div class="card-industrial p-6 flex flex-col items-center text-center border-b-4 border-b-slate-500">
            ...
            <p class="text-[10px] text-slate-400 font-bold mt-2 uppercase">Aset Terdaftar</p>
        </div>
        ...
        <div class="card-industrial p-6 flex flex-col items-center text-center border-b-4 border-b-green-500">
            ...
            <p class="text-[10px] text-green-400 font-bold mt-2 uppercase">Unit Siap Operasi</p>
        </div>
        ...
        <div class="card-industrial p-6 flex flex-col items-center text-center border-b-4 border-b-amber-500">
            ...
            <p class="text-[10px] text-amber-400 font-bold mt-2 uppercase">Unit Menunggu Antrian</p>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div class="lg:col-span-2 card-industrial overflow-hidden">
            <div class="px-5 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
                ...
                <span class="px-3 py-1 rounded-md text-[10px] font-black bg-blue-50 text-blue-700 border border-blue-100 uppercase">
                ...
                <table class="w-full text-sm text-left">
                    ...
                    <tbody class="divide-y divide-slate-200" x-data="{ expanded: null }">
                        @forelse($unitStatuses as $row)
                            <tr class="hover:bg-blue-50 transition-colors cursor-pointer group {{ $loop->even ? 'bg-slate-100/80' : 'bg-white' }} border-b border-slate-200/60" @click="expanded = expanded === {{ $row->id }} ? null : {{ $row->id }}">
                                <td class="px-5 py-4">
                                    <div class="flex items-center gap-3">
