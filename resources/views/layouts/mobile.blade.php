...
<head>
    ...
    <style>
        * {
        ...
        select.form-input-field[class*="pl-9"] {
            padding-left: 2.25rem !important;
        }

        input.form-input-field[class*="pl-11"],
        select.form-input-field[class*="pl-11"] {
...
<body>
    <div class="min-h-screen flex flex-col items-center justify-start" style="padding-bottom: 110px;">
        ...
        <p class="mt-6 mb-4 text-xs text-slate-400 font-medium text-center">© {{ date('Y') }} PT. Tri Machmud Jaya</p>
    </div>
</body>
